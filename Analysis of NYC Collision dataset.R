### Analysis of the NYC Collision Dataset

#Loading the dataset
nydata <- read.csv("C:/Dipti MSEM/Courses/7. Data Viz/Project 1/NYPD_Motor_Vehicle_Collisions.csv", header=TRUE, stringsAsFactors=FALSE)
